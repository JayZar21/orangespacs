;; Copyright (C) 2016 Gianluca Romanin, Nasser Alshammari

;; Author: Gianluca Romanin, (modification of spacemacs-theme by Nasser Alshammari)
;; URL: <https://github.com/JayZar21/orangespacs>
;;
;; Version: 1.0
...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (act2          (if (eq variant 'dark) (if (true-color-p) "#69407A" "#444444") (if (true-color-p) "#d3d3e7" "#afafd7")))
        (base          (if (eq variant 'dark) (if (true-color-p) "#FFFFFF" "#b2b2b2") (if (true-color-p) "#655370" "#5f5f87")))
        ...
        (border        (if (eq variant 'dark) (if (true-color-p) "#62367A" "#111111") (if (true-color-p) "#b3b9be" "#b3b9be")))
        ...
        (func          (if (eq variant 'dark) (if (true-color-p) "#FF8A0A" "#FF8A0A") (if (true-color-p) "#6c3163" "#8700af")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#00AB6E" "#2aa198") (if (true-color-p) "#2d9574" "#2aa198")))
        ...
        (type          (if (eq variant 'dark) (if (true-color-p) "#FF187D" "#df005f") (if (true-color-p) "#ba2f59" "#af005f")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#4BA3DB" "#8787d7") (if (true-color-p) "#715ab1" "#af5fd7")))
...
(deftheme orangespacs "orangespacs theme")
(create-spacemacs-theme 'dark 'orangespacs)
(provide-theme 'orangespacs)
